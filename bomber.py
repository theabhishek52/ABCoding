...
def bann_text():
    clr()
    logo = """
       d8888 888888b.    .d8888b.                888 d8b                   
      d88888 888  "88b  d88P  Y88b               888 Y8P                   
     d88P888 888  .88P  888    888               888                       
    d88P 888 8888888K.  888         .d88b.   .d88888 888 88888b.   .d88b.  
   d88P  888 888  "Y88b 888        d88""88b d88" 888 888 888 "88b d88P"88b 
  d88P   888 888    888 888    888 888  888 888  888 888 888  888 888  888 
 d8888888888 888   d88P Y88b  d88P Y88..88P Y88b 888 888 888  888 Y88b 888 
d88P     888 8888888P"   "Y8888P"   "Y88P"   "Y88888 888 888  888  "Y88888 
                                                                       888 
                                                                  Y8b d88P 
                                                                   "Y88P"  """
    if ASCII_MODE:
...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("ABCoding was updated to the latest version")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("ABCoding is up-to-date")
        mesgdcrt.GeneralMessage("Starting ABCoding")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("ABCoding was created by SpeedX")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("ABCoding will work only in Python v3")
    sys.exit()
...
description = """ABCoding - Your Friendly Spammer Application

ABCoding can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

ABCoding is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by SpeedX !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start ABCoding with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start ABCoding with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start ABCoding with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update ABCoding")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current ABCoding contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current ABCoding version")
